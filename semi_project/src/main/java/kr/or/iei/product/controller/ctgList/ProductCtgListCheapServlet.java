...
/**
 * Servlet implementation class ProductCtgListCheapServlet
 */
...
public class ProductCtgListCheapServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> productCtgList = service.selectCategoryListCheap(category, memberNo); //카테고리랑 일치하는 상품 리스트 가져오기
