		...
		<main class="content">
			<section class="section join-wrap">
				...
				<form action='/member/join' <%-- 요청 URL  --%>
				      ...
				      <!-- 프로필 사진 등록 하는 부분, 기본 이미지 필요할듯 -> 추후 추가여부 결정 -->
				      ...
				      <div class="input-wrap">
				      	  ...
				      	  <div class="input-item select-item">
				      	  	<select class="birth-select" id="birthYear"></select>
				      	  	<select class="birth-select" id="birthMonth"></select>
				      	  	<select class="birth-select" id="birthDay"></select>
				      	  </div>
				      ...
				      <div class="input-wrap">
				      	  ...
				      	  <div class="input-item input-addr addr-postcode">
				      	  	<input type="text" id="memberAddr_postcode" placeholder="우편번호">
						  ...
						  <div class="input-item input-addr addr-basic">
							<input type="text" id="memberAddr_address" placeholder="주소">
						  </div>
						  <div class="input-item input-addr addr-detail">
							<input type="text" id="memberAddr_detailAddress" placeholder="상세주소">
						  </div>
						  <div class="input-item input-addr addr-extra">
							<input type="text" id="memberAddr_extraAddress" placeholder="참고항목">
				      	  </div>
				      </div>
				       ...
				       <div class="input-wrap">
				      	  ...
				      	  <div class="input-item">
				      	  	...
				      	  	<input type="text" id="memberEmailDomain" name="memeberEmailDomain">
        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                if(data.userSelectedType === 'R'){
                    ...
                    document.getElementById("memberAddr_extraAddress").value = extraAddr;
                
                } else {
                    document.getElementById("memberAddr_extraAddress").value = '';
                }

                // 우편번호와 주소 정보를 해당 필드에 넣는다.
                document.getElementById('memberAddr_postcode').value = data.zonecode;
                document.getElementById("memberAddr_address").value = addr;
                // 커서를 상세주소 필드로 이동한다.
                document.getElementById("memberAddr_detailAddress").focus();
            }
        }).open();
    }
	</script>
