...
<body>
	<div class="wrap">
		...
		<div class="main-wrap">
			...
			<div class="filter">
	            <select id="filter" onchange="filterChange(this, '${ctg.categoryCode}')">
	                <option value="newest">최신순</option>
	                <option value="oldest">오래된순</option>
	                <option value="cheaper">최저가순</option>
	                <option value="expensive">최고가순</option>
	                <option value="setPrice" selected>가격설정</option>
	            </select>
	...
	<script>
		...
		//필터 항목에서 설정 변경 시
		function filterChange(obj, ctg){
			switch($(obj).val()){
			case "newest" :
				$(".price-range").hide();
				location.href="/product/categoryListDesc?ctg=" + ctg;
				break;
			case "oldest" :
				$(".price-range").hide();
				location.href="/product/categoryListAsc?ctg=" + ctg;
				break;
			case "cheaper" :
				$(".price-range").hide();
				location.href="/product/categoryListCheap?ctg=" + ctg;
				break;
			case "expensive" :
				$(".price-range").hide();
				location.href="/product/categoryListExpen?ctg=" + ctg;
				break;
			case "setPrice" :
				$(".price-range").show();
				break;
