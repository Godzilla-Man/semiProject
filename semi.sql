...
SELECT P.ORDER_NO, P.PRODUCT_NO, P.SELLER_MEMBER_NO, P.BUYER_MEMBER_NO, P.DELIVERY_ADDR, P.DELIVERY_FEE, P.ORDER_AMOUNT, P.PG_PROVIDER, P.PG_TRANSACTION_ID, P.DEAL_DATE, P.PURCHASE_STATUS_CODE, PROD.PRODUCT_NAME, PROD.PRODUCT_PRICE, SELLER.MEMBER_NICKNAME AS SELLER_NICKNAME, PS.STATUS_NAME AS PURCHASE_STATUS_NAME, (SELECT FILE_PATH FROM (SELECT FILE_PATH FROM TBL_FILE F WHERE F.PRODUCT_NO = P.PRODUCT_NO ORDER BY F.FILE_NO ASC) WHERE ROWNUM = 1) AS THUMBNAIL_PATH FROM TBL_PURCHASE P JOIN TBL_PROD PROD ON P.PRODUCT_NO = PROD.PRODUCT_NO JOIN TBL_MEMBER SELLER ON P.SELLER_MEMBER_NO = SELLER.MEMBER_NO JOIN TBL_PURCHASE_STATUS PS ON P.PURCHASE_STATUS_CODE = PS.PURCHASE_STATUS_CODE WHERE P.BUYER_MEMBER_NO = ? ORDER BY P.DEAL_DATE DESC;
SELECT P.ORDER_NO, P.PRODUCT_NO, P.SELLER_MEMBER_NO, P.BUYER_MEMBER_NO, P.DELIVERY_ADDR, P.DELIVERY_FEE, P.ORDER_AMOUNT, P.PG_PROVIDER, P.PG_TRANSACTION_ID, P.DEAL_DATE, P.PURCHASE_STATUS_CODE, PROD.PRODUCT_NAME, PROD.PRODUCT_PRICE, SELLER.MEMBER_NICKNAME AS SELLER_NICKNAME, PS.STATUS_NAME AS PURCHASE_STATUS_NAME, (SELECT FILE_PATH FROM (SELECT FILE_PATH FROM TBL_FILE F WHERE F.PRODUCT_NO = PROD.PRODUCT_NO ORDER BY F.FILE_NO ASC) WHERE ROWNUM = 1) AS THUMBNAIL_PATH FROM TBL_PURCHASE P JOIN TBL_PROD PROD ON P.PRODUCT_NO = PROD.PRODUCT_NO JOIN TBL_MEMBER SELLER ON P.SELLER_MEMBER_NO = SELLER.MEMBER_NO JOIN TBL_PURCHASE_STATUS PS ON P.PURCHASE_STATUS_CODE = PS.PURCHASE_STATUS_CODE WHERE P.BUYER_MEMBER_NO = ? ORDER BY P.DEAL_DATE DESC;
SELECT P.ORDER_NO, P.PRODUCT_NO, P.SELLER_MEMBER_NO, P.BUYER_MEMBER_NO, P.DELIVERY_ADDR, P.DELIVERY_FEE, P.ORDER_AMOUNT, P.PG_PROVIDER, P.PG_TRANSACTION_ID, P.DEAL_DATE, P.PURCHASE_STATUS_CODE, PROD.PRODUCT_NAME, PROD.PRODUCT_PRICE, SELLER.MEMBER_NICKNAME AS SELLER_NICKNAME, PS.STATUS_NAME AS PURCHASE_STATUS_NAME, (SELECT FL.FILE_PATH FROM (SELECT F.FILE_PATH, F.FILE_NO FROM TBL_FILE F WHERE F.PRODUCT_NO = PRODUCT_NO ORDER BY F.FILE_NO ASC) FL WHERE ROWNUM = 1) AS THUMBNAIL_PATH FROM TBL_PURCHASE P JOIN TBL_PROD PROD ON P.PRODUCT_NO = PROD.PRODUCT_NO JOIN TBL_MEMBER SELLER ON P.SELLER_MEMBER_NO = SELLER.MEMBER_NO JOIN TBL_PURCHASE_STATUS PS ON P.PURCHASE_STATUS_CODE = PS.PURCHASE_STATUS_CODE WHERE P.BUYER_MEMBER_NO = '2505200025' ORDER BY P.DEAL_DATE DESC;